...
<table>
<tr>
    <td class="label">Original Checkout Date</td>
    <td><?php echo $ori_issuedate; ?></td>
</tr>

<tr>
    <td class="label">Current Extension Date</td>
    <td><?php echo $ori_extendate; ?></td>
</tr>

<tr>
    <td class="label">New Extension Date</td>
    <td><?php echo $new_extendate; ?></td>
</tr>

<tr>
    <td class="label">Current Return Date</td>
    <td><?php echo $ori_returndate; ?></td>
</tr>

<tr>
    <td class="label">New Estimated Return Date</td>
